      ...
      try {
        ...
        if (hasMessage || wantsAssistant) {
          ...
          if (data.newChat) {
            ...
            if (data.systemPrompt) updateChatSettings(targetChat.id, { systemPrompt: data.systemPrompt })
          } else {
            ...
            activeChat.history.forEach((msg, i) => {
              ...
              elements.push(
                <div key={i} className={`chat-message chat-message-${msg.role}${i === completionGlowIdx ? ' chat-message-new' : ''}`}>
                  ...
                  <div className="chat-message-bubble">
                    {/* Keep a compact speaker label for screen readers and
                        long conversations while the visual treatment makes
                        the two sides easy to scan. */}
