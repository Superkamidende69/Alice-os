  ...
  return (
    <div className="page page--narrow talk-page">
      <div className="talk-col">
        ...
        <div className="card pad-lg mb-md talk-card">
          {/* Voice visualizer (hero) */}
          <ModelBrain modelName={selectedModel} llmName={selectedModelInfo?.llm} audioRef={audioRef} status={status} active={isConnected} />
          ...
          {/* Transcript */}
          <div className="talk-transcript talk-chat-panel mb-md">
            {transcript.length === 0 && (
